...
class DroneBoss(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.targetvert>-1:
            ...
            if abs(self.targetvert-self.rect.top)>5:
        ...
        if len(self.Tail)==0 and random.randint(1,45)>40:
            self.vmove += (2 - random.randint(1,3))
        ...
        if random.randint(1,45)>35: self.Retarget()
        
    def Retarget(self):
        self.targetvert = self.gameCore.GoodGuy.rect.midright[1] - 64
